...
public class NotationTest {
	...
	public void testComplexConvertInfixToPostfix() {
		...
		try {
			postfixResult = Notation.convertInfixToPostfix(complexInfix);
	...
	public void testIntermediateConvertInfixToPostfix() {
		String postfixResult;
		try {
			postfixResult = Notation.convertInfixToPostfix(intermediateInfix);
	...
	public void testIntermediateConvertPostfixToInfix() {
		String infixResult;
		try {
			infixResult = Notation.convertPostfixToInfix(intermediatePostfix);
	...
	public void testEasyConvertInfixToPostfix() {
		String postfixResult;
		try {
			postfixResult = Notation.convertInfixToPostfix(easyInfix);
