...
public class Notation {
	...
	public static String convertInfixToPostfix(String complexInfix) throws InvalidNotationFormatException {
		...
		NotationStack<Character> stack = new NotationStack<>(100);
		NotationQueue<Character>queue=new NotationQueue<>(100);
		...
		for(int i=0; i<InfixIntoChars.length; i++) {
			...
			else if(InfixIntoChars[i]=='+'||InfixIntoChars[i]=='-'||InfixIntoChars[i]=='*'||InfixIntoChars[i]=='/'||InfixIntoChars[i]=='%') {
	...
	public static String convertPostfixToInfix(String postfix) throws InvalidNotationFormatException {
        ...
        for (int i = 0; i < postfixIntoChars.length; i++) {
            ...
            //operator
            else if (postfixIntoChars[i]=='+'||postfixIntoChars[i]=='-'||postfixIntoChars[i]=='*'||postfixIntoChars[i]=='/'||postfixIntoChars[i]=='%') {
	...
	public static double evaluatePostfixExpression(String postfix) throws InvalidNotationFormatException {
		// TODO Auto-generated method stub
		NotationStack <String> evaluatePostfix= new NotationStack<String>();
